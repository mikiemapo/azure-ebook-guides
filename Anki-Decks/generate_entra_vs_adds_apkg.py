...
# Mirror the main template exactly
DECK_NAME = "AZ-104 Study Guide::Deep Dive Segments::Entra ID vs AD DS — Deep Dive"
DECK_ID = 2151312311
...
# Point to the Deep Dive CSV you created
csv_path = Path('/Users/mike1macbook/Documents/MY STUFF DOCS AND ALL/EBOOK/AZ-104-Critical-Priorities-Study-Deck/Deep Dive Segment/Entra ID vs AD DS.csv')
...
package.media_files = []
output_path = Path('/Users/mike1macbook/Documents/MY STUFF DOCS AND ALL/EBOOK/Anki-Decks/ENTRA_ID_vs_AD_DS_DEEP_DIVE.apkg')
